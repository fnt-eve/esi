...
func (c *SSOAuthenticator) newRequest(method, urlStr string, body interface{}, _ string) (*http.Request, error) {
...
func (c *SSOAuthenticator) doJSON(method, urlStr string, body any, v any, mediaType string, auth oauth2.TokenSource) (*http.Response, error) {
...
func AddTokenToRequest(ctx context.Context, req *http.Request) error {
